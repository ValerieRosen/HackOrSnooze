$(async function () {
  ...
  // global storyList variable set to none
  let storyList = null;

  // global user variable set to none
  let currentUser = null;

  //see if user is logged in to populate submit/favorites and my stories
  ...
  //setting up new account and user instance
  ...
  //listening for submit button to add story info
  ...
  //hides when user profile is clicked
  ...
  //listening for favorites and showing favorites only
  ...
  //navigating to page for user created stories
  ...
  //deleting a single story from my stories page
  ...
  //checking local storage to see if user is logged in
  ...
  //reset forms and hide login info
  ...
  //rendering function to call the StoryList.getStories static method,
